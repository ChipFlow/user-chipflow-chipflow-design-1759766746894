...
from chipflow_lib.platforms import attach_data, SoftwareBuild, UARTSignature, SPISignature, QSPIFlashSignature, JTAGSignature
...
class MySoC(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        # SPI 1
        m.submodules.spi_1 = spi_1 = SPIPeripheral()
        csr_decoder.add(spi_1.bus, name="spi_1", addr=self.csr_spi_base + 1 * self.periph_offset - self.csr_base)
        connect(m, flipped(self.spi_1), spi_1.spi_pins)
